...
- {pin_num: '57', pin_signal: PTB9/SPI1_PCS1/UART3_CTS_b/FB_AD20, label: 'J1[6]', identifier: DEBUG_PIN}
...
- {pin_num: '73', pin_signal: CMP1_IN1/PTC3/LLWU_P7/SPI0_PCS1/UART1_RX/FTM0_CH2/CLKOUT/I2S0_TX_BCLK, label: 'J1[16]', identifier: MOTOR_RX}
- {pin_num: '64', pin_signal: PTB18/CAN0_TX/FTM2_CH0/I2S0_TX_BCLK/FB_AD15/FTM2_QD_PHA, label: 'J1[1]', identifier: ENC_R_A}
- {pin_num: '65', pin_signal: PTB19/CAN0_RX/FTM2_CH1/I2S0_TX_FS/FB_OE_b/FTM2_QD_PHB, label: 'J1[3]', identifier: ENC_R_B}
- {pin_num: '71', pin_signal: ADC0_SE15/PTC1/LLWU_P6/SPI0_PCS3/UART1_RTS_b/FTM0_CH0/FB_AD13/I2S0_TXD0, label: 'J1[5]', identifier: ENC_L_B}
- {pin_num: '80', pin_signal: ADC1_SE4b/CMP0_IN2/PTC8/FTM3_CH4/I2S0_MCLK/FB_AD7, label: 'J1[7]', identifier: ENC_L_A}
...
- {pin_num: '76', pin_signal: PTC4/LLWU_P8/SPI0_PCS0/UART1_TX/FTM0_CH3/FB_AD11/CMP1_OUT, label: 'J2[4]', identifier: MOTOR_TX}
...
- {pin_num: '83', pin_signal: ADC1_SE7b/PTC11/LLWU_P11/I2C1_SDA/FTM3_CH7/I2S0_RXD1/FB_RW_b, label: 'J4[10]', identifier: IMU_SDA}
- {pin_num: '82', pin_signal: ADC1_SE6b/PTC10/I2C1_SCL/FTM3_CH6/I2S0_RX_FS/FB_AD5, label: 'J4[12]', identifier: IMU_SCL}
...
- {pin_num: '86', pin_signal: PTC14/UART4_RX/FB_AD25, label: 'J199[3]/BT_TX', identifier: BT_RX}
- {pin_num: '87', pin_signal: PTC15/UART4_TX/FB_AD24, label: 'J199[4]/BT_RX', identifier: BT_TX}
...
- pin_list:
  - {pin_num: '78', peripheral: GPIOC, signal: 'GPIO, 6', pin_signal: CMP0_IN0/PTC6/LLWU_P10/SPI0_SOUT/PDB0_EXTRG/I2S0_RX_BCLK/FB_AD9/I2S0_MCLK, identifier: SW2,
    direction: INPUT, gpio_interrupt: kPORT_InterruptRisingEdge, pull_select: up, pull_enable: enable}
  - {pin_num: '38', peripheral: GPIOA, signal: 'GPIO, 4', pin_signal: PTA4/LLWU_P3/FTM0_CH1/NMI_b/EZP_CS_b, direction: INPUT, gpio_interrupt: kPORT_InterruptRisingEdge,
...
void BOARD_Buttons(void)
{
    ...
    GPIO_PinInit(BOARD_BUTTONS_SW3_GPIO, BOARD_BUTTONS_SW3_PIN, &SW3_config);
    ...
    GPIO_PinInit(BOARD_BUTTONS_SW2_GPIO, BOARD_BUTTONS_SW2_PIN, &SW2_config);

    /* PORTA4 (pin 38) is configured as PTA4 */
    PORT_SetPinMux(BOARD_BUTTONS_SW3_PORT, BOARD_BUTTONS_SW3_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTA4 (pin 38): Interrupt on rising edge */
    PORT_SetPinInterruptConfig(BOARD_BUTTONS_SW3_PORT, BOARD_BUTTONS_SW3_PIN, kPORT_InterruptRisingEdge);
    ...
    PORT_SetPinMux(BOARD_BUTTONS_SW2_PORT, BOARD_BUTTONS_SW2_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTC6 (pin 78): Interrupt on rising edge */
    PORT_SetPinInterruptConfig(BOARD_BUTTONS_SW2_PORT, BOARD_BUTTONS_SW2_PIN, kPORT_InterruptRisingEdge);
...
void BT_PINS(void)
{
    ...
    PORT_SetPinMux(BT_PINS_BT_RX_PORT, BT_PINS_BT_RX_PIN, kPORT_MuxAlt3);

    /* PORTC15 (pin 87) is configured as UART4_TX */
    PORT_SetPinMux(BT_PINS_BT_TX_PORT, BT_PINS_BT_TX_PIN, kPORT_MuxAlt3);
}
...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '64', peripheral: GPIOB, signal: 'GPIO, 18', pin_signal: PTB18/CAN0_TX/FTM2_CH0/I2S0_TX_BCLK/FB_AD15/FTM2_QD_PHA, direction: INPUT, gpio_interrupt: kPORT_InterruptRisingEdge}
  - {pin_num: '65', peripheral: GPIOB, signal: 'GPIO, 19', pin_signal: PTB19/CAN0_RX/FTM2_CH1/I2S0_TX_FS/FB_OE_b/FTM2_QD_PHB, direction: INPUT}
  ...
  - {pin_num: '71', peripheral: GPIOC, signal: 'GPIO, 1', pin_signal: ADC0_SE15/PTC1/LLWU_P6/SPI0_PCS3/UART1_RTS_b/FTM0_CH0/FB_AD13/I2S0_TXD0, direction: INPUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void ENCODER_PINS(void)
{
    ...
    gpio_pin_config_t ENC_R_A_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTB18 (pin 64)  */
    GPIO_PinInit(ENCODER_PINS_ENC_R_A_GPIO, ENCODER_PINS_ENC_R_A_PIN, &ENC_R_A_config);

    gpio_pin_config_t ENC_R_B_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTB19 (pin 65)  */
    GPIO_PinInit(ENCODER_PINS_ENC_R_B_GPIO, ENCODER_PINS_ENC_R_B_PIN, &ENC_R_B_config);

    gpio_pin_config_t ENC_L_B_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC1 (pin 71)  */
    GPIO_PinInit(ENCODER_PINS_ENC_L_B_GPIO, ENCODER_PINS_ENC_L_B_PIN, &ENC_L_B_config);

    gpio_pin_config_t ENC_L_A_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PTC8 (pin 80)  */
    GPIO_PinInit(ENCODER_PINS_ENC_L_A_GPIO, ENCODER_PINS_ENC_L_A_PIN, &ENC_L_A_config);

    /* PORTB18 (pin 64) is configured as PTB18 */
    PORT_SetPinMux(ENCODER_PINS_ENC_R_A_PORT, ENCODER_PINS_ENC_R_A_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTB18 (pin 64): Interrupt on rising edge */
    PORT_SetPinInterruptConfig(ENCODER_PINS_ENC_R_A_PORT, ENCODER_PINS_ENC_R_A_PIN, kPORT_InterruptRisingEdge);

    /* PORTB19 (pin 65) is configured as PTB19 */
    PORT_SetPinMux(ENCODER_PINS_ENC_R_B_PORT, ENCODER_PINS_ENC_R_B_PIN, kPORT_MuxAsGpio);

    /* PORTC1 (pin 71) is configured as PTC1 */
    PORT_SetPinMux(ENCODER_PINS_ENC_L_B_PORT, ENCODER_PINS_ENC_L_B_PIN, kPORT_MuxAsGpio);

    /* PORTC8 (pin 80) is configured as PTC8 */
    PORT_SetPinMux(ENCODER_PINS_ENC_L_A_PORT, ENCODER_PINS_ENC_L_A_PIN, kPORT_MuxAsGpio);

    /* Interrupt configuration on PORTC8 (pin 80): Interrupt on rising edge */
    PORT_SetPinInterruptConfig(ENCODER_PINS_ENC_L_A_PORT, ENCODER_PINS_ENC_L_A_PIN, kPORT_InterruptRisingEdge);
}
...
void DRIVER_PINS(void)
{
    ...
    PORT_SetPinMux(DRIVER_PINS_MOTOR_RX_PORT, DRIVER_PINS_MOTOR_RX_PIN, kPORT_MuxAlt3);

    /* PORTC4 (pin 76) is configured as UART1_TX */
    PORT_SetPinMux(DRIVER_PINS_MOTOR_TX_PORT, DRIVER_PINS_MOTOR_TX_PIN, kPORT_MuxAlt3);
...
- options: {callFromInitBoot: 'true', coreID: core0, enableClock: 'true'}
- pin_list:
  - {pin_num: '82', peripheral: I2C1, signal: SCL, pin_signal: ADC1_SE6b/PTC10/I2C1_SCL/FTM3_CH6/I2S0_RX_FS/FB_AD5, open_drain: enable, pull_select: no_init, pull_enable: disable}
  - {pin_num: '83', peripheral: I2C1, signal: SDA, pin_signal: ADC1_SE7b/PTC11/LLWU_P11/I2C1_SDA/FTM3_CH7/I2S0_RXD1/FB_RW_b, open_drain: enable, pull_select: no_init,
    pull_enable: disable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void IMU_PINS(void)
{
    ...
    PORT_SetPinMux(IMU_PINS_IMU_SCL_PORT, IMU_PINS_IMU_SCL_PIN, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(IMU_PINS_IMU_SDA_PORT, IMU_PINS_IMU_SDA_PIN, kPORT_MuxAlt2);
...
void GPS_PINS(void)
{
    ...
    PORT_SetPinMux(GPS_PINS_TMR_1588_0_PORT, GPS_PINS_TMR_1588_0_PIN, kPORT_MuxAlt3);

    /* PORTC17 (pin 91) is configured as UART3_TX */
    PORT_SetPinMux(GPS_PINS_TMR_1588_1_PORT, GPS_PINS_TMR_1588_1_PIN, kPORT_MuxAlt3);
}
...
void BOARD_Pins(void)
{
    ...
    GPIO_PinInit(BOARD_PINS_DEBUG_PIN_GPIO, BOARD_PINS_DEBUG_PIN_PIN, &DEBUG_PIN_config);

    /* PORTB9 (pin 57) is configured as PTB9 */
    PORT_SetPinMux(BOARD_PINS_DEBUG_PIN_PORT, BOARD_PINS_DEBUG_PIN_PIN, kPORT_MuxAsGpio);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
